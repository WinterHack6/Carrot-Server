...
public class SwaggerConfig {
    ...
    private static final Contact DEFAULT_CONTACT = new Contact("이수찬", "http://www.carrotmarket.com", "tncksdl05@gmail.com");
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("carrot.market"))
